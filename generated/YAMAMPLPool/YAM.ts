...
export class YAM__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class YAM extends ethereum.SmartContract {
  static bind(address: Address): YAM {
    return new YAM("YAM", address);
  }
  ...
  checkpoints(param0: Address, param1: BigInt): YAM__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new YAM__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<YAM__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new YAM__checkpointsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
