...
export class YAMAMPLPool extends ethereum.SmartContract {
  static bind(address: Address): YAMAMPLPool {
    return new YAMAMPLPool("YAMAMPLPool", address);
  }
  ...
  try_ampl_eth_uni_lp(): ethereum.CallResult<Address> {
